  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'mnemonic',
          text: '**ARPPU** — сколько платит тот, кто **уже платит**. **ARPU** — сколько в среднем приносит **каждый пришедший**, включая не купивших (ARPU = ARPPU × C1). Аналогия: ARPPU — средний чек в кафе; ARPU — выручка кафе, делённая на всех заглянувших, включая ушедших без заказа.',
        },
      ],
    },
    {
