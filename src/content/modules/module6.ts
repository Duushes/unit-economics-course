  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'mnemonic',
          text: '**[[CAC]]** — сколько стоит «свидание» (привлечь клиента). **[[LTV]]** — сколько «отношения» принесут за всю жизнь. Бизнес здоров, когда отношения окупают свидание с запасом (LTV > CAC), и чем быстрее окупают (payback), тем лучше.',
        },
      ],
    },
  ],
